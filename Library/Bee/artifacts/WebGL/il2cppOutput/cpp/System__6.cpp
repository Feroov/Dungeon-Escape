...
{
	Exception_t* ___m_remoteEndPointException = il2cpp_codegen_get_marshal_directive_exception("Cannot marshal field 'm_remoteEndPoint' of type 'UdpReceiveResult': Reference type field marshaling is not supported.");
